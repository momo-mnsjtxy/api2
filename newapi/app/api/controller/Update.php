...
class Update
{
	...
	public function Wordtime(Request $request){
	    if(!empty($request->param('time'))){
	...
	public function headimg(Request $request){
	    $kw = $request->param('kw');
	    $kwn = $request->param('kwn');
	    $a = $request->param('start');
	    $b = $a+30;//recommend
	...
	//words
	public function qianming(Request $request){
	    $a = $request->param('start');
	    $b = $a+100;//recommend
	...
	public function wangming(Request $request){
	    $a = $request->param('start');
	    $b = $a+100;//recommend
