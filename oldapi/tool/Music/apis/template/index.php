...
<head>
    <meta charset="UTF-8">
    <title>与梦城 - 音乐搜索器 - 多站合一音乐搜索,音乐在线试听 </title>
    ...
    <meta name="keywords" content="与梦城,梦音乐搜索,音乐搜索器,音乐试听,音乐在线听,网易云音乐,QQ音乐,酷狗音乐,酷我音乐,虾米音乐,百度音乐,一听音乐,咪咕音乐,荔枝FM,蜻蜓FM,喜马拉雅FM,全民K歌,5sing原创翻唱音乐">
...
<body>
    ...
    <section class="am-g about">
        <div class="am-container am-margin-vertical-xl">
            <header class="am-padding-vertical">
                ...
                <p class="am-text-center">与梦城-多站合一音乐搜索解决方案</p>
            </header>
            <hr>
    ...
    <footer class="footer">
        <p class="am-text-sm">v<?php echo MC_VERSION; ?>&nbsp;&copy;&nbsp;<?php echo date('Y'); ?>&nbsp;<a href="https://www.gqink.cn" target="_blank">与梦城</a>&nbsp;<a href="javascript:void(0)" data-am-modal="{target: '#copr-info'}">免责声明</a></p>
    </footer>
