...
//if (server('HTTP_X_REQUESTED_WITH') === 'XMLHttpRequest') {
    $music_input          = trim(REQUEST('input'));
    $music_filter         = REQUEST('filter');
    $music_type           = REQUEST('type');
    $music_page           = (int) REQUEST('page');
    ...
    response($music_response, 'success', '');
//}
echo json_decode(response($music_response, 'success', ''));
